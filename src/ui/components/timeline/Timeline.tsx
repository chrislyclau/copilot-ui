...
export function Timeline({
    ...
    return (
        <div className="flex flex-col gap-4 min-w-0 flex-1">
            ...
            <div
                id="timeline-stream-container"
                className="relative flex flex-col gap-3 py-3 mt-1 grow min-h-[400px]"
            >
                {turns.length === 0 ? (
                    <div className="flex flex-col items-center justify-center p-12 text-center bg-white dark:bg-zinc-900/40 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs my-4 grow">
                        <Search
                            size={28}
                            className="text-zinc-400 dark:text-zinc-600 mb-3"
                        />
                        <h3 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">
                            No telemetry logs found
                        </h3>
                        <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 max-w-sm font-sans leading-relaxed">
                            No items in this session matched your active
                            filters. Try clearing your search text.
                        </p>
                    </div>
                ) : (
                    turns.map((turn, tIdx) => {
