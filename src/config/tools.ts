/**
 * The run_terminal_docker tool definition moved into the agentCore package in
 * extraction phase 2b (agentCore session builders attach it to every auditor
 * session). Re-exported here so existing app/script consumers keep compiling
 * unchanged. All other tool definitions below remain app-side.
 */
export { RUN_TERMINAL_DOCKER_TOOL } from '../agentCore/config/tools';
